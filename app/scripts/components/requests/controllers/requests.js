...
(function() {
    ...
    define(['lodash'], function(_) {
        var RequestsController = function($location, $scope, $interval, RequestTrackingService, ServerService, UtilService, RequestService, $log, $timeout) {
            $scope.tasks = [];
        ...
        return ['$location', '$scope', '$interval', 'RequestTrackingService', 'ServerService', 'UtilService', 'RequestService', '$log', '$timeout', RequestsController];
    });
})();
